        ...
        <div key={phase.id} className="bg-white border border-gray-200 rounded-lg p-6">
          <div className="flex items-start justify-between mb-4">
            <div className="flex items-center gap-3">
              <span className="flex items-center justify-center w-8 h-8 rounded-full bg-gray-100 text-sm font-bold text-gray-600 border border-gray-200">
                {i + 1}
              </span>
              <div>
                <h3 className="text-sm font-semibold text-gray-900">{phase.name}</h3>
                <span className="text-[10px] font-mono text-gray-400">{phase.id}</span>
              </div>
            </div>
          ...
          <div className="mb-4">
            ...
            <p className="text-sm text-gray-700">{phase.scope}</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
            <div>
              <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Core Integrations</p>
            ...
            <div>
              <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Training & SOPs</p>
              <div className="space-y-1.5">
          ...
          <div className="mb-4">
            ...
            <div className="space-y-2">
              {phase.deliverables.map((d) => (
                <div key={d.name} className="border border-gray-100 rounded p-3">
          ...
          <div>
            <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Exit Criteria (Acceptance Gates)</p>
            <div className="space-y-1.5">
