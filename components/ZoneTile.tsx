  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-2 gap-2 text-xs text-gray-600 dark:text-gray-400">
        <div>
          <span className="text-gray-400 dark:text-gray-500">Risk Score</span>
        ...
        <div>
          ...
          <p className="font-medium text-gray-900 dark:text-gray-100">{zone.pedestrian_count}</p>
        </div>
        <div>
          <span className="text-gray-400 dark:text-gray-500">Cameras</span>
          <p className="font-medium text-gray-900 dark:text-gray-100">
